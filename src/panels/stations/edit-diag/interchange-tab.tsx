    ...
    render() {
        return (
            <List>
                ...
                {['mtr', 'shmetro'].includes(window.urlParams.get('style')) && <><Divider />
                    <ListItem>
                        <ListItemText>
                ...
                {window.urlParams.get('style') === 'mtr' && <InterchangeMore stnId={this.props.stnId} />}
            </List>
        )
    }
}
...
const InterchangeMore = (props: MoreProps) => {
    const { t } = useTranslation();
                ...
                <ListItemText
                    ...
                    secondary={
                        <RadioGroup name="tick_direc" row
                            value={stnTrans.tick_direc}
                            onChange={tickDirecChange}
                        >
                            <FormControlLabel
                                value="l"
