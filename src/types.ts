export type ProvidedCanvas = 'destination' | 'runin' | 'railmap';

export enum DirectionLong {
    left,
    right,
}
export enum NeighbourPl {
    parents,
    children,
}
/**
...
export type InterchangeInfo = [string, string, string, '#000' | '#fff', string, string];
