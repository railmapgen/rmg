 ...
 */
export const routes = (stnList: StationDict) =>
    useMemo(() => {
        var stack = ['linestart'];
 ...
 */
export const _stnOutdegree = (stnId: string, stnList: StationDict) => stnList[stnId].children.length;

/**
 * Indegree of a station node.
 */
export const _stnIndegree = (stnId: string, stnList: StationDict) => stnList[stnId].parents.length;
