const params = {
    ...
    stn_list: {
        ...
        j9vj: {
            name: ['亦庄文化园', 'Yizhuang Cultule Park'],
            secondaryName: false,
            num: '06',
            services: ['local'],
            parents: ['4d3c'],
        ...
        hgbf: {
            ...
            branch: { left: [], right: [] },
            transfer: {
                info: [[['beijing', 'xjl', '#D22630', '#fff', '亦庄T1', 'Yizhuang T1 Line']]],
                tick_direc: 'r',
                paid_area: true,
                osi_names: [],
            },
        ...
        sfxq: {
            name: ['亦庄火车站', 'Yizhuang Railway Station'],
            secondaryName: false,
            num: '14',
            services: ['local'],
            parents: ['uvwu'],
