const params = {
    ...
    y_pc: 40,
    branch_spacing: 45,
    theme: ['beijing', 'bj7', '#FFC56E', '#fff'],
    direction: 'r',
    current_stn_idx: 'l1mz',
    platform_num: '2',
    stn_list: {
        '6918': {
            name: ['广渠门外', 'Guangqumen Wai'],
            secondaryName: false,
            num: '11',
            services: ['local'],
            parents: ['b5ig'],
