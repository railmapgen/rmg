const params = {
    style: 'gzmtr',
    svg_height: 300,
    padding: 4.447876447876448,
    y_pc: 40,
    branch_spacing: 45,
    theme: ['guangzhou', 'gz2', '#00629b', '#fff'],
    direction: 'r',
    current_stn_idx: 'w2zj',
    platform_num: '2',
    stn_list: {
        linestart: {
            parents: [],
        ...
        lcmc: {
            ...
            transfer: {
                ...
                paid_area: true,
                osi_names: [],
                info: [[['other', 'other', '#c4d600', '#000', '广佛线', 'Guangfo Line']]],
            },
            facility: '',
            secondaryName: false,
        },
    ...
    svgWidth: { destination: 1200, runin: 1200, railmap: 2100, indoor: 2100 },
    notesGZMTR: [],
