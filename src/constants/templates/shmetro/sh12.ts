const params = {
    ...
    theme: ['shanghai', 'sh12', '#007B5F', '#fff'],
    direction: 'r',
    ...
    stn_list: {
        ...
        '2q8m': {
            parents: ['dhsq'],
            children: ['uh7r'],
            name: ['国际客运中心', 'International Cruise Terminal'],
            branch: {
                left: [],
                right: [],
            },
