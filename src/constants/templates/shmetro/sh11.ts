const params = {
    ...
    stn_list: {
        ...
        wr6q: {
            name: ['上海游泳馆', 'Shanghai Swimming Center'],
            secondaryName: false,
            num: '00',
            services: ['local'],
            parents: ['0kp1'],
