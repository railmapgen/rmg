const params = {
    ...
    stn_list: {
        ...
        n4at: {
            parents: ['l1mz'],
            children: ['8gmo'],
            name: ['虹桥2号航站楼', 'Hongqiao Airport Terminal 2'],
            branch: { left: [], right: [] },
            num: '03',
            transfer: {
                tick_direc: 'r',
        ...
        '4nai': {
            parents: ['m5bp'],
            children: ['dhsq'],
            name: ['上海科技馆', 'Shanghai Science & Technology Museum'],
            branch: { left: [], right: [] },
            num: '16',
            transfer: { tick_direc: 'r', paid_area: true, osi_names: [], info: [[]] },
            services: ['local'],
        ...
        uh7r: {
            parents: ['2q8m'],
            children: ['cwlm'],
            name: ['张江高科', 'Zhangjiang High Technology Park'],
            branch: { left: [], right: [] },
            num: '19',
            transfer: { tick_direc: 'r', paid_area: true, osi_names: [], info: [[]] },
            services: ['local'],
        ...
        ww5f: {
            parents: ['8qia'],
            children: ['r3cg'],
            name: ['创新中路', 'Middle Chuangxin Road'],
            branch: { left: [], right: [] },
            num: '23',
            transfer: { tick_direc: 'r', paid_area: true, osi_names: [], info: [[]] },
            services: ['local'],
        ...
        mx89: {
            name: ['浦东国际机场', 'Pudong International Airport'],
            secondaryName: false,
            num: '29',
            services: ['local'],
            parents: ['r4df'],
            ...
            branch: { left: [], right: [] },
            transfer: {
                info: [[], [], [['shanghai', 'maglev', '#009090', '#fff', '磁浮线', 'Maglev Line']]],
                tick_direc: 'r',
                paid_area: true,
                osi_names: [],
            },
