...
const Guangzhou: PaletteEntry[] = [
    ...
    },
    {
        ...
        name: {
            ...
            [LanguageCode.ChineseSimp]: '12号线',
            [LanguageCode.ChineseTrad]: '12號線',
        },
        colour: '#59621D',
    },
    {
    ...
    },
    {
        id: 'gz20',
        name: {
            [LanguageCode.English]: 'Line 20',
            [LanguageCode.ChineseSimp]: '20号线',
            [LanguageCode.ChineseTrad]: '20號線',
        },
        colour: '#D9027D',
    },
    {
        id: 'gz21',
        name: {
            [LanguageCode.English]: 'Line 21',
            [LanguageCode.ChineseSimp]: '21号线',
            [LanguageCode.ChineseTrad]: '21號線',
        },
        colour: '#201747',
    },
    {
    ...
    },
    {
        id: 'gfl',
        name: {
            [LanguageCode.English]: 'Guangfo Line',
            [LanguageCode.ChineseSimp]: '广佛线',
            [LanguageCode.ChineseTrad]: '廣佛線',
        },
        colour: '#C4D600',
    },
    {
        id: 'apm',
        name: {
            [LanguageCode.English]: 'APM Line',
            [LanguageCode.ChineseSimp]: '珠江新城旅客自动输送系统',
            [LanguageCode.ChineseTrad]: '珠江新城旅客自動輸送系統',
        },
        colour: '#00B5E2',
    },
    {
        id: 'thz1',
        name: {
            [LanguageCode.English]: 'THZ1',
            [LanguageCode.ChineseSimp]: '海珠环岛新型有轨电车',
    ...
    },
    {
        id: 'gfloop',
        name: {
            [LanguageCode.English]: 'Guangzhou-Foshan Loop Line',
            [LanguageCode.ChineseSimp]: '广佛环线',
            [LanguageCode.ChineseTrad]: '廣佛環線',
        },
        colour: '#AD96DC',
    },
    {
        id: 'gfz',
        name: {
            [LanguageCode.English]: 'Guangzhou-Foshan-Zhaoqing Line',
            [LanguageCode.ChineseSimp]: '广佛𦘦线',
            [LanguageCode.ChineseTrad]: '廣佛肇線',
        },
        colour: '#A45A2A',
    },
];
