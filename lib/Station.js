...
class OSI11Station extends Int2Station {
  constructor(id, data) {
    ...
    super(id, data); // [this._osiNameZH, this._osiNameEN] = data.transfer[0];

    _defineProperty(this, "_osiNameZH", void 0);

    _defineProperty(this, "_osiNameEN", void 0);
  ...
  get osiNameHTML() {
    ...
    return $('<g>', {
      ...
      'class': 'Name ' + this._nameClass
    }).append($('<text>').addClass('rmg-name__zh rmg-name__mtr--osi').text(this._osiNameZH)).append($('<text>', {
      'x': 0,
      'dy': 12,
...
class OSI12Station extends Int3Station {
  constructor(id, data) {
    ...
    [this._osiNameZH, this._osiNameEN] = data.interchange[1][0]; // this.#osiType = data.change_type.substring(6,7); // u(npaid) or p(aid);

    _classPrivateFieldSet(this, _osiType2, data.change_type.split('_').reverse()[0][0]);
  ...
  get osiNameHTML() {
    ...
    return $('<g>', {
      ...
      'dy': 12,
      'class': 'rmg-name__en rmg-name__mtr--osi'
    }).text(this._osiNameEN.split('\\')[0]).append($('<tspan>', {
      x: 0,
      dy: 10
    }).text(this._osiNameEN.split('\\')[1] || '')));
  }
...
class OSI22Station extends OSI12Station {
  ...
  get origIntNameHTML() {
    ...
    var dy = this._namePos == 1 ? 25 + 5.953125 : -25 + 5.953125 - 18.65625 - 13 * (nameZHLn - 1) - 7 * (nameENLn - 1); // dy += this._dy;
    // var nameClass = (this._state == -1) ? 'Pass' : 'Future';
...
class OSI22EndStation extends OSI12Station {
  constructor(id, data) {
    ...
    _origIntCity2.set(this, {
      writable: true,
      value: void 0
    });

    _origIntLine2.set(this, {
      writable: true,
      value: void 0
    });

    _origIntColour2.set(this, {
      writable: true,
      value: void 0
    });

    _origIntFg2.set(this, {
      writable: true,
      value: void 0
    });

    _origIntNameZH2.set(this, {
      writable: true,
      value: void 0
    });

    _origIntNameEN2.set(this, {
      writable: true,
      value: void 0
    });

    [_classPrivateFieldDestructureSet(this, _origIntCity2).value, _classPrivateFieldDestructureSet(this, _origIntLine2).value, _classPrivateFieldDestructureSet(this, _origIntColour2).value, _classPrivateFieldDestructureSet(this, _origIntFg2).value, _classPrivateFieldDestructureSet(this, _origIntNameZH2).value, _classPrivateFieldDestructureSet(this, _origIntNameEN2).value] = data.interchange[0][2];
  }

  get origIntTickHTML() {
    var tickRotation = this._namePos == 1 ? 180 : 0;

    var tickColour = _classPrivateFieldGet(this, _origIntColour2);
  ...
  get origIntNameHTML() {
    var [nameHTML, nameZHLn, nameENLn] = joinIntName([_classPrivateFieldGet(this, _origIntNameZH2), _classPrivateFieldGet(this, _origIntNameEN2)], 15, 7);
...
var _origIntCity2 = new WeakMap();

var _origIntLine2 = new WeakMap();

var _origIntColour2 = new WeakMap();

var _origIntFg2 = new WeakMap();

var _origIntNameZH2 = new WeakMap();

var _origIntNameEN2 = new WeakMap();
...
class IntStationGZ extends StationGZ {
  ...
  get intNameHTML() {
    ...
    var intTextZHEls = intNameZHss.map((names, idx) => {
      ...
      }).text(intNameSplitOk ? names[0] : '')).append($('<tspan>', {
        dy: -0.5,
        'alignment-baseline': 'central'
    ...
    var intTextENEls = this._intNameEN.map((name, idx) => {
      if (name.length > 10) {
        return $('<text>', {
          y: 19.5 + idx * 28,
          class: 'rmg-name__en rmg-name__gzmtr--int-small'
        }).text(name);
      } else {
        return $('<text>', {
          y: 19.5 + idx * 28,
    ...
    this._intFg.map((fg, idx) => {
      if (fg == '#fff' || this._state == -1) {
