...
class Int2StationGZ extends StationGZ {
  constructor(id, data) {
    ...
    _intNameZH3.set(this, {
      writable: true,
      value: void 0
    });

    _intNameEN3.set(this, {
      writable: true,
      value: void 0
    });

    [_classPrivateFieldDestructureSet(this, _intCity3).value, _classPrivateFieldDestructureSet(this, _intLine3).value, _classPrivateFieldDestructureSet(this, _intColour3).value, _classPrivateFieldDestructureSet(this, _intFg2).value, _classPrivateFieldDestructureSet(this, _intNameZH3).value, _classPrivateFieldDestructureSet(this, _intNameEN3).value] = data.interchange[0][0];
  }

  get intTickHTML() {
    var tickColour = _classPrivateFieldGet(this, _intColour3);
  ...
  get intNameHTML() {
    var intNameZHs = _classPrivateFieldGet(this, _intNameZH3).match(/[\d]+|[\D]+/g);
    ...
    }).text(_classPrivateFieldGet(this, _intNameEN3));

    if (_classPrivateFieldGet(this, _intFg2) == '#fff' || this._state == -1) {
    ...
    var intBoxEl = $('<use>', {
      ...
      fill: this._state == -1 ? '#aaa' : _classPrivateFieldGet(this, _intColour3)
    });
    return $('<g>', {
      'text-anchor': 'middle',
      transform: `translate(${this._x},${this._y + 23})`
    }).append(intBoxEl, intTextZHEl, intTextENEl); // var [nameHTML, nameZHLn, nameENLn] = joinIntName([this.#intNameZH, this.#intNameEN], 15, 7);
    // var dy = (this._namePos == 0) ? 25 + 5.953125 : -25 + 5.953125 - 18.65625 - 13*(nameZHLn-1) - 7*(nameENLn-1);
    // dy += this._dy;
    // // var nameClass = (this._state == -1) ? 'Pass' : 'Future';
    // return $('<g>', {
...
var _intCity3 = new WeakMap();

var _intLine3 = new WeakMap();

var _intColour3 = new WeakMap();

var _intFg2 = new WeakMap();

var _intNameZH3 = new WeakMap();

var _intNameEN3 = new WeakMap();