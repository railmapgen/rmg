...
class Int2Station extends Station {
  constructor(id, data) {
    super(id, data); // [this.#intCity, this.#intLine, this.#intColour, this.#intNameZH, this.#intNameEN] = data.transfer[1];
    ...
    [_classPrivateFieldDestructureSet(this, _intCity).value, _classPrivateFieldDestructureSet(this, _intLine).value, _classPrivateFieldDestructureSet(this, _intColour).value, _classPrivateFieldDestructureSet(this, _intNameZH).value, _classPrivateFieldDestructureSet(this, _intNameEN).value] = data.interchange[0][0];
  }
...
class OSI12Station extends Int3Station {
  constructor(id, data) {
    ...
    [_classPrivateFieldDestructureSet(this, _osiNameZH2).value, _classPrivateFieldDestructureSet(this, _osiNameEN2).value] = data.interchange[1][0];
...
class OSI22EndStation extends OSI12Station {
  constructor(id, data) {
    ...
    _classPrivateFieldSet(this, _osiType3, data.change_type.split('_')[2]);

    [_classPrivateFieldDestructureSet(this, _origIntCity).value, _classPrivateFieldDestructureSet(this, _origIntLine).value, _classPrivateFieldDestructureSet(this, _origIntColour).value, _classPrivateFieldDestructureSet(this, _origIntNameZH).value, _classPrivateFieldDestructureSet(this, _origIntNameEN).value] = data.interchange[0][2];
  }
  ...
  get iconHTML() {
    ...
    var iconType = `osi22end${_classPrivateFieldGet(this, _osiType3)}_hk${this._state == -1 ? '_pass' : ''}`;
