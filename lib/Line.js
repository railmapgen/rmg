...
class Line {
  ...
  _stnNamePos(stnId) {
    ...
    return pos; // return (this.#txtFlip) ? Number(!pos) : pos;
  }
  ...
  drawDestInfo() {
    ...
    var lineNameZH = _classPrivateFieldGet(this, _destLegacy) ? _classPrivateFieldGet(this, _lineNames)[0] : '';
    var lineNameEN = _classPrivateFieldGet(this, _destLegacy) ? `${_classPrivateFieldGet(this, _lineNames)[1]} ` : '';
    $('#dest_name').append(`<g text-anchor="${txtAnchor}"> <text class="DestNameZH">${lineNameZH}往${destNameZH}</text> <text dy="80" class="DestNameEN">${lineNameEN}to ${destNameEN}</text> </g>`);
